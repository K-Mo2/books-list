...
const books: BookCard[] = [
  ...
  },
  {
    ...
    imageUrl: "https://m.media-amazon.com/images/I/817HaeblezL._AC_UY218_.jpg",
  },
  {
    id: 3,
    title:
    ...
    imageUrl: "https://m.media-amazon.com/images/I/71LeIRBPrtL._SY385_.jpg",
  },
  {
    id: 4,
...
export const Home = () => {
  ...
  return (
    <main>
      ...
      <div className={styles.addBookButtonContainer}>
        <button onClick={addBookHandler} className={styles.addBookButton}>
          Add Books
        </button>
      </div>
